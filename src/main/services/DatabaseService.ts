...
export class DatabaseService {
  ...
  static saveTask(
    ...
    db.insert(tasks)
      .values({
        ...
        linkedBranchCreatedByDash: data.linkedBranchCreatedByDash ?? false,
        createdAt: now,
        updatedAt: now,
      })
      .onConflictDoUpdate({
  ...
  private static mapTask(row: typeof tasks.$inferSelect): Task {
    ...
    return {
      ...
      linkedBranch: row.linkedBranch ?? null,
      linkedBranchCreatedByDash: row.linkedBranchCreatedByDash ?? false,
